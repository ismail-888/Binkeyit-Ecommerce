    ...
    <div className="w-36 p-4 bg-white rounded">
      ...
      <div className="grid grid-cols-2 gap-3 py-2">
        <button
          ...
          className="border  text-sm px-1 py-1 border-green-600 bg-green-100 text-green-800 hover:bg-green-200 rounded"
        >
          Edit
        </button>
        <button
          onClick={() => setOpenDelete(true)}
          className="border  text-sm px-1 py-1 border-green-600 bg-red-100 text-red-800 hover:bg-red-200 rounded"
        >
          Delete
        </button>
      </div>
      ...
      {openDelete && (
        <section className="fixed top-0 right-0 left-0 bottom-0 bg-neutral-600/70 z-50 p-4 flex justify-center items-center ">
